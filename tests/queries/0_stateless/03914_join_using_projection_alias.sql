...
SELECT t1.val, concat('_1', 2, 2) AS id FROM t1 LEFT JOIN t2 ON t1.id = t2.id LEFT JOIN t3 USING (id) ORDER BY t1.val ASC; -- { serverError INVALID_JOIN_ON_EXPRESSION }
