...
$CLICKHOUSE_CLIENT -q "DROP DATABASE IF EXISTS 03913_database;"
$CLICKHOUSE_CLIENT -q "
...
$CLICKHOUSE_CLIENT -q "
select database || '.' || name FROM system.tables where database = '03913_database' and engine = 'MergeTree'
SETTINGS show_data_lake_catalogs_in_system_tables = 1;
"

$CLICKHOUSE_CLIENT -q "DROP DATABASE 03913_database;"
