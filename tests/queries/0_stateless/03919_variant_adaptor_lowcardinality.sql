...
-- 1. An array with mixed types including LowCardinality to produce Variant with LC variant
...
SELECT toDecimal128(5.5, 18) * arrayJoin([toUInt256(1), toLowCardinality(60)]);
