...
Similar to `firstSignificantSubdomainCustom` but uses RFC 3986 compliant URL parsing instead of the simplified algorithm.
    ...
    FunctionDocumentation documentation_custom_rfc = {description_custom_rfc, syntax_custom_rfc, arguments_custom_rfc, {}, returned_value_custom_rfc, examples_custom_rfc, {}, category_custom_rfc};
