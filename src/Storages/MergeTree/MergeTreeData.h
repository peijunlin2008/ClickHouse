...
public:
    ...
    ConditionSelectivityEstimatorPtr getConditionSelectivityEstimator(const StorageSnapshotPtr & storage_snapshot, const Names & required_columns, ContextPtr local_context) const override;
